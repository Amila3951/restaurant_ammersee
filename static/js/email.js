...
function sendEmail(form) { 
    const email = form.elements.email.value;  // Get the email address from the form (dot notation)
    const username = form.elements.username.value;  // Get the username from the form (dot notation)
